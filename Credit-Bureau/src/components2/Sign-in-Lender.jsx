    ...
    <div className="signin-wrapper">
      <div className="signin-content">
        ...
        <div className="signin-left">
          <h1 className="signin-heading">New Partner ?</h1>
          <p className="signin-subtext">
            Create your account to view your partnership
            <br />
            and more
          </p>
          <button
            ...
            onClick={() => navigate("/sign-up-partner")}
          >
            SIGN UP
          </button>
        </div>
        ...
        <div className="signin-form-section">
          ...
          <form className="signin-form" onSubmit={handleSignIn}>
            <h1 className="signin-title">Sign In to Your Partners Account</h1>

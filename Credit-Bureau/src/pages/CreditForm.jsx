    ...
    <Container className="form-container">
                ...
                <Col md={6}>
                  <Form.Group controlId={`billDueDate-${index}`}>
                    ...
                    <Form.Control
                      type="date"
                      value={bill.dueDate}
                      onChange={(e) => handleBillChange(index, "dueDate", e.target.value)}
                    />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group controlId={`paymentDate-${index}`}>
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => handleBillChange(index, "paymentDate", e.target.value)}
                    />
                  </Form.Group>
                </Col>
              </Row>
      ...
      <div className="tips-card mt-5">
        ...
        <div className="tip-box">
          <ul>
            <li>
              <strong>Pay on time:</strong> Timely payments improve your credit rating.
            </li>
            <li>
              <strong>Keep balances low:</strong> Don’t max out your credit cards.
            </li>
            <li>
              <strong>Check reports:</strong> Review your credit report regularly for errors.
            </li>
            <li>
              <strong>Limit applications:</strong> Avoid too many credit applications in a short time.
            </li>
            <li>
              <strong>Stay informed:</strong> Understand how credit works and stay updated.
            </li>
          </ul>
        </div>
      </div>
